    ...
    if (window.DotMetricsInitScript == undefined) {
        ...
        function start(hasConsent){
            ...
            var doorUrl = 'http%3a%2f%2fuk-script.dotmetrics.net%2fdoor.js%3fd%3dwww.bbc.com%26t%3dnewsgnl';
            if(fbia){pvs=1;}
                        ...
                        window.DotMetricsSettings =
                                    {
                                        ...
                                        ScriptDebugUrl:  'https://download.dotmetrics.net/Script/script.debug.js?v=628ed128-408c-4148-bd11-1ebaf93c6ed7',
                                        ...
                                        NCSScriptDebugUrl: 'https://download.dotmetrics.net/Script/ncs-script.debug.js?v=77fb8729-ae55-4a22-b26e-9d5e5aab1ecb',
